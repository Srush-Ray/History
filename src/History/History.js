  ...
  constructor() {
    ...
    this.state = {
      text: [
        ...
        <p>
          <span
            style={{ color: "#ffdfc9", fontSize: "100px", lineHeight: "0.5" }}
          >
            lll
          </span>
          <br />
          <span style={{ color: "#ffdfc9", fontSize: "30px" }}>Tier</span>{" "}
          <br />
        ...
        <p style={{ color: "#ffdfc9", fontSize: "12px" }}>
          <p
            style={{ fontWeight: "bolder", color: "#ffdfc9", fontSize: "16px" }}
          >
        ...
        <p style={{ color: "#ffdfc9", fontSize: "14px" }} className="textFont">
          Minimum 11 eligible integrated practitioners from any town/city/area
          can come together and function locally as per the Constitution of
          NIMA.
          <p>
            All Local/District Branches in a state form a State Branch of NIMA,
            which is governed by its state council. Local Branch Managing
            Committees send their representatives in proportion to the number of
            their members to the State Council. The State Council meets twice a
            year, elect its Office Bearers and carries out its duties for the
            entire State. The details regarding the working of the
            Local/District Branch and State Branches can be seen in the booklet
            of By-Laws of NIMA
          </p>
        </p>,
        <p className="textFont" style={{ color: "#ffdfc9" }}>
          The Central Council is formed by the representatives coming from all
          the State Councils every year. In proportion to their membership
          strength. The state Secretary is necessarily the first representative
          of the State Branch on the Central Council. The Central Council is the
          important body in which are vested the general control, management and
          direction of policy of the Association. The central council in its
          annual meeting elects the Central Office bearers who form the
          Executive Committee of NIMA which executes the programme laid down by
          the Central Council.
        </p>,
        ...
        <p style={{ fontSize: "13px", color: "#ffdfc9" }}>
          ...
          enrolling maximim life members. The life membership subscription is
          kept in long term fixed deposit in a Nationalised Bank and the annual
          interest accrued on it is distributed. The Association has opened
          Associate Membership for non integrated qualified practitioners who
          believe in integration. The Association year for Branches is from 1
